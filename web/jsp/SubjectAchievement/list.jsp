				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：科目成绩管理 &gt; 科目成绩列表</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
							...
							<TBODY>
								<TR>
									...
									<FORM id="pageForm" name="classForm"
										action="${pageContext.request.contextPath }/TChengjiAction_list"
										method=post>
										<!-- 隐藏域.当前页码 -->
											...
											<TBODY>
												<TR>
                                                    ...
                                                    <INPUT class=textbox id=sChannel2
                                                     style="WIDTH: 80px" maxLength=50 name="chengji_kemu" value="${param['kemu']}">
                                                    </TD>
													<TD>姓名：</TD>
													<TD>
														<input type="hidden" name="tXuesheng.xs_id" id="xs_id" value="${param['tXuesheng.xs_id']}" />
														<INPUT class=textbox style="WIDTH: 80px" maxLength=50 name="stuednt_name"  id="student_name" value="${param['userName']}" >
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<s:iterator value="#pageBean.list" var="chengji" >
												<TR
													style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													<TD><s:property value="#chengji.id" /></TD>
													<TD><s:property value="#chengji.students.xuehao" /></TD>
													<TD><s:property value="#chengji.students.userName" /></TD>
													<TD><s:property value="#chengji.kemu" /></TD>
													<TD><s:property value="#chengji.fenshu" /></TD>
													<TD>
													<a href="${pageContext.request.contextPath }/TChengjiAction_toEdit?chengji_id=<s:property value="#chengji.id" />">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/TChengjiServlet?method=delete&chengji_Id=${chengji.id}">删除</a>
													</TD>
												</TR>
												</s:iterator>
