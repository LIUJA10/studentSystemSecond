				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：加分管理 &gt; 加分列表</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE borderColor=#cccccc cellSpacing=0 cellPadding=0
							...
							<TBODY>
								<TR>
									<TD height=25>
									<FORM id="pageForm" name="classForm"
										action="${pageContext.request.contextPath }/TJiafenAction_list"
										method=post>
										<!-- 隐藏域.当前页码 -->
											...
											<TBODY>
												<TR>
													...
													<TD>
														...
														style="WIDTH: 80px" maxLength=50 name="jiafen_id" value="${param['jiafen_id']}">
													</TD>
													<TD>加分项目名称：</TD>
                                                    <TD>
                                                    <INPUT class=textbox id=sChannel2
                                                    style="WIDTH: 80px" maxLength=50 name="jiafen_name" value="${param['xiangmu']}">
                                                    </TD>
                                                    <TD>加分项目分数：</TD>
                                                    <TD>
                                                    <INPUT class=textbox id=sChannel2
                                                    style="WIDTH: 80px" maxLength=50 name="jiafen_goals" value="${param['fenzhi']}">
                                                    </TD>
                                                    <TD>加分时间：</TD>
                                                    <TD>
                                                    <INPUT class=textbox id=sChannel2
                                                     style="WIDTH: 80px" maxLength=50 name="jiafen_time" value="${param['shijian']}">
                                                    </TD>
													<TD>学生名称：</TD>
													<TD>
														<input type="hidden" name="tXuesheng.xsId" id="xsId" value="${param['tXuesheng.xsId']}" />
														<INPUT class=textbox style="WIDTH: 80px" maxLength=50 name="stuednt_name"  id="student_name" value="${param['xingming']}" >
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<s:iterator value="#pageBean.list" var="jiafen" >
												<TR
													style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													<TD><s:property value="#jiafen.jiafen_id" /></TD>
													<TD><s:property value="#jiafen.xiangmu" /></TD>
													<TD><s:property value="#jiafen.fenzhi" /></TD>
													<TD><s:property value="#jiafen.shijian" /></TD>
													<TD><s:property value="#jiafen.students.mingcheng" /></TD>
													<TD>
													<a href="${pageContext.request.contextPath }/TJiafenAction_toEdit?jiafen_id=<s:property value="#jiafen.jiafen_id" />">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/TJiafenServlet?method=delete&jiafen_Id=${jiafen.jiafen_id}">删除</a>
													</TD>
												</TR>
												</s:iterator>
