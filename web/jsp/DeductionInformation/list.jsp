				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：扣分管理 &gt; 扣分列表</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
											...
											<TBODY>
												<TR>
													...
													<TD>
														...
														style="WIDTH: 80px" maxLength=50 name="koufen_id" value="${param['koufen_id']}">
													</TD>
													<TD>扣分项目名称：</TD>
                                                    <TD>
                                                    <INPUT class=textbox id=sChannel2
                                                    style="WIDTH: 80px" maxLength=50 name="koufen_name" value="${param['xiangmu']}">
                                                    </TD>
                                                    <TD>扣分项目分数：</TD>
                                                    <TD>
                                                    <INPUT class=textbox id=sChannel2
                                                    style="WIDTH: 80px" maxLength=50 name="koufen_goals" value="${param['fenzhi']}">
                                                    </TD>
                                                    <TD>扣分项目时间：</TD>
                                                    <TD>
                                                    <INPUT class=textbox id=sChannel2
                                                     style="WIDTH: 80px" maxLength=50 name="koufen_time" value="${param['shijian']}">
                                                    </TD>
													<TD>学生名称：</TD>
													<TD>
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<s:iterator value="#pageBean.list" var="koufen" >
												<TR
													style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													<TD><s:property value="#koufen.koufen_id" /></TD>
													<TD><s:property value="#koufen.xiangmu" /></TD>
													<TD><s:property value="#koufen.fenzhi" /></TD>
													<TD><s:property value="#koufen.shijian" /></TD>
													<TD><s:property value="#koufen.students.mingcheng" /></TD>
													<TD>
													<a href="${pageContext.request.contextPath }/TKoufenAction_toEdit?koufen_id=<s:property value="#koufen.koufen_id" />">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/TKoufenServlet?method=delete&koufen_Id=${koufen.koufen_id}">删除</a>
													</TD>
												</TR>
												</s:iterator>
