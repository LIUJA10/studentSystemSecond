				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：班级管理 &gt; 班级列表</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
							...
							<TBODY>
								<TR>
									...
									<FORM id="pageForm" name="classForm"
										action="${pageContext.request.contextPath }/TBanjiAction_list"
										method=post>
										<!-- 隐藏域.当前页码 -->
											...
											<TBODY>
												<TR>
													...
													<TD>
														...
														style="WIDTH: 80px" maxLength=50 name="class_name" value="${param['mingcheng']}">
													</TD>
													<TD>学生名称：</TD>
													<TD>
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<s:iterator value="#pageBean.list" var="class" >
												<TR
													style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													<TD><s:property value="#class.class_id" /></TD>
													<TD><s:property value="#class.mingcheng" /></TD>
													<TD>
													<a href="${pageContext.request.contextPath }/TBanjiAction_toEdit?class_id=<s:property value="#class.class_id" />">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/TBanjiServlet?method=delete&class_Id=${class.class_id}">删除</a>
													</TD>
												</TR>
												</s:iterator>
