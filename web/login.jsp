...
<script type="text/javascript">
	...
	function check(){
		if(form1.radioleixian.value=="管理员"){
			document.form1.action="TAdminAction_login";
			document.form1.submit();
			return true;
		}
		if(form1.radioleixian.value=="学生"){
			document.form1.action="TXueshengAction_login";
			document.form1.submit();
			return true;
		}
		return false;
...
<TABLE cellSpacing=0 cellPadding=0 width=900 align=center border=0>
  <TBODY>
  <TR>
    <TD style="HEIGHT: 105px"><IMG src="images/login_1.jpg" 
  border=0></TD></TR>
  <TR>
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px" width=150><INPUT id=txtName
                  style="WIDTH: 130px" name="userName" type=text></TD>
              ...
              <TR>
                ...
                <TR>
                <TD style="HEIGHT: 28px">用户类型：</TD>
                <TD style="HEIGHT: 28px"><input type=radio name="radioleixian" value="管理员" checked="checked">管理员
                <input type=radio name="radioleixian" value="学生" >学生
                </TD>
                </TR>
              <TR>
